...
{
    return(
        <nav className="bg-gray-900/50 w-full top-0 backdrop-blur-md z-50">
            <div className="max-w-7xl mx-auto  px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <a href="#home" className="text-gray-300 hover:text-white">About us</a>
                        <a href="#home" className="text-gray-300 hover:text-white">Workshop</a>
